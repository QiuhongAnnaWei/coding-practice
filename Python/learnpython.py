...
####################################################
    ...
    # csv_reader() is a generator function:
    # it opens a file, loops through each line, and yields each row instead of returning it
    ...
    # yield: when the Python yield statement is hit, the program suspends function execution
    # and returns the yielded value to the caller. (In contrast, return stops function execution
    ...
    # internal stack, and any exception handling.
    ...
    print(next(multi_obj)) # Traceback (most recent call last):...

    # Just as you can create a list comprehension, you can create generator
    # comprehensions/generator expressions as well.
